...
pSD = sum(nullDist)/100   # 0.66 proportion of random clusters of all spiders whose SDs were more extreme
pSD2 = sum(nullDist2)/100 # 0.78 proportion of random clusters of clustered spiders whose SDs were more extreme
